    ...
    <AuthLayout>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        ...
        <div className="flex flex-col gap-1.5">
          <label htmlFor="fullName" className="text-[0.8125rem] font-medium text-muted">
            Full name
          </label>
          <input
            id="fullName"
            ...
            className="h-11 w-full rounded-md border border-[var(--color-border)] bg-card px-3 text-body placeholder:text-muted transition-all duration-150 focus:border-primary-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-400"
          />
        </div>
