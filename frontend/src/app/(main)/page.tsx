        ...
        <div className="flex gap-3">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full h-11 pl-10 pr-3 rounded-md border border-neutral-border text-body bg-surface-raised transition-all duration-150 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-400 focus:border-primary-600 placeholder:text-muted"
            />
          </div>
          <Button
            variant="primary"
